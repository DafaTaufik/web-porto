...
export default function AboutMe() {
    ...
    return(
        <section id="about" ref={sectionRef} className="w-full h-[800px] flex flex-col items-center relative bg-white">
            ...
            <div 
                ref={bgRef}
                className="absolute top-0 h-[800px] bg-black w-screen left-1/2 transform -translate-x-1/2"
            ></div>
            
            {/* Content that sits on top of the animated background */}
            <span className="font-HWT text-5xl  md:text-6xl text-white mt-28 relative z-10">About Me</span>

            <div className="px-7 w-screen flex flex-col md:flex-row justify-center md:justify-between md:px-32 mt-16 md:mt-28 relative z-10">
