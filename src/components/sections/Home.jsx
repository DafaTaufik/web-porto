...
export function Home() {
  return (
    <section id="home" className="relative w-full h-screen">
      ...
      <div className="absolute inset-0 z-20 pointer-events-none px-3 md:px-24">
        <div className="h-full flex flex-col justify-center">
          ...
          <h3 className="text-sm md:text-md font-sans font-medium w-[300px] md:w-[420px]">A 7th-semester Informatics student who's love the world of web and mobile development.</h3>
        </div>
      </div>
    </section>
  );
