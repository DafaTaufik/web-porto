    ...
    <section id="home" className="relative w-full h-screen">
      ...
      <div className="absolute inset-0 z-20 px-3 md:px-24 pointer-events-none">
        <div className="h-full flex flex-col justify-center">
          <h1 className="text-[#1D1D1D] text-3xl md:text-4xl font-HWT">hi, im</h1>
          <h1 className="text-[#1D1D1D] text-7xl w-32 md:w-full md:text-8xl font-HWT mt-1">Dafa Taufik</h1>
          <h1 className="text-[#1D1D1D] text-6xl md:text-7xl font-HWT">Al Latief</h1>
          <h2 className="mt-5 mb-5 text-lg md:text-3xl text-[#1D1D1D] font-HWT">Android & Backend Developer</h2>

          <div className="flex items-center gap-2 mb-4">
            <img src={ic_map} alt="Map Icon" className="w-5 h-5" />
            <span className="text-gray-500 text-base md:tex-base font-medium font-sans">Tangerang, Indonesia</span>
          </div>
          <h3 className="text-sm md:text-lg font-sans text-gray-700 font-medium w-[300px] md:w-[420px]">
          ...
          <div className="mt-5 flex gap-4 pointer-events-auto">
            <button
              className="px-4 py-2 bg-[#1D1D1D] text-white text-base font-semibold cursor-pointer rounded-md shadow-md hover:bg-gray-800 transition duration-400 transform hover:-translate-y-1"
            ...
            <button
              className="px-4 py-2 bg-white text-[#1D1D1D] border border-black cursor-pointer text-base font-semibold rounded-md shadow-md hover:bg-gray-100 transition duration-400 transform hover:-translate-y-1"
