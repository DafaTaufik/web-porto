        ...
        {navItems.map((navItem, idx) => {
          ...
          return (
            <button
              ...
              className={clsx(
                "relative font-HWT items-center flex transition-all duration-300 rounded-full px-3 py-1.5 cursor-pointer",
                isActive && "bg-black dark:bg-white shadow-md" // Background untuk active state
              )}
            >
              {/* Mobile: Hanya icon */}
              <span className={clsx(
                ...
                isActive 
                  ? "text-white dark:text-black" // Active state colors
              ...
              <span className={clsx(
                "hidden sm:flex items-center space-x-2 transition-colors duration-200",
                isActive 
                  ? "text-white dark:text-black" // Active state colors
                  : "dark:text-neutral-50 text-neutral-600 dark:hover:text-neutral-300 hover:text-neutral-500"
              )}>
