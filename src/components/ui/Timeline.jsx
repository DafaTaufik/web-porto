  ...
  return (
    <div className="w-full xl:ml-20 bg-white dark:bg-neutral-950 font-sans md:px-10" ref={containerRef}>
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="font-HWT text-5xl md:text-6xl mb-4 text-black dark:text-white max-w-4xl">
          Experience
        </h2>
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky border border-black flex flex-row z-40 top-40 self-start w-fit ml-2">
              ...
              <h3 className="font-HWT block text-xl mt-[7px] md:pl-20 md:text-5xl font-bold text-neutral-500 dark:text-neutral-500">
                {item.title}
              </h3>
            </div>
