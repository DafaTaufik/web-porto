import omb_1 from "../assets/Image/Omb/1_omb.jpg";
import omb_2 from "../assets/Image/Omb/2_omb.jpg";
import omb_3 from "../assets/Image/Omb/3_omb.jpg";
import omb_4 from "../assets/Image/Omb/4_omb.jpg";
...
export const OrganizationalExperienceData = [
  {
    title: "2023",
    content: (
      <div className="w-fit ml-2">
        ...
        <div className=" w-fit gap-2 grid grid-cols-2 md:gap-4 mt-5">
          ...
          <img src={omb_4} alt="startup template" className="h-auto w-[100px] md:w-[350px] rounded-lg transform transition duration-300 hover:scale-105" />
          <img src={omb_1} alt="startup template" className="h-auto w-[100px] md:w-[350px] rounded-lg transform transition duration-300 hover:scale-105" />
          <img src={omb_6} alt="startup template" className="h-auto w-[100px] md:w-[350px] rounded-lg transform transition duration-300 hover:scale-105" />
        </div>
      </div>
    ),
  },
